...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("baris ke-4: saya meneruskn baris ketiga");

        System.out.print("baris ke-5: hallo mahmuy???");
        System.out.println("baris ke-6: hallo juga hobloh!!!");

        System.out.print("baris ke-7: hai bro, mari kit kongkow \n");
        System.out.print("baris ke-8: kongkow kemana bro?\n");
        System.out.print("baris ke-9: mari kit kongkow ke citamiang!!!\n");
